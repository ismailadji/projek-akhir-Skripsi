                ...
                <?php
                   $no=1; foreach ($data as $row) {?>
                        <tr>
                            ...
                            <td>
                                 <?php
                                    $kode = "".$row->id_buku."|".$row->isbn."|".$row->judul_buku."|".$row->pengarang."|".$row->penerbit."|".$row->tahun_terbit."|".$row->jumlah_buku."|".$row->tanggal_masuk."";
                            ...
                            <td>
                                <a href="<?= base_url()?>Tampilan_user/Tam_buku/detail/<?= $row->id_buku;?>" class="btn btn-info btn-xs">Detail</a>
