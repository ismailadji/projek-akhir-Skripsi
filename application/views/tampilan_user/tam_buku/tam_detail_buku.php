        ...
        <div class="row">
            <div class="col-md-6">
                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <?php
                                $no=1;  {?>
                                <?php
                                    $kode = "".$data['id_buku']."|".$data['isbn']."|".$data['judul_buku']."|".$data['pengarang']."|".$data['penerbit']."|".$data['tahun_terbit']."|".$data['jumlah_buku']."|".$data['tanggal_masuk']."";
                ...
                <!-- kembali di kontroler anggota -->
                    <a href="<?= base_url()?>tampilan_user/tam_buku" class="btn btn-warning">Cancel</a> 
                </div>
              <!-- /.box-footer -->
                </div>
            </div>
