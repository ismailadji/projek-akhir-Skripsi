                ...
                <?php
                   $no=1; foreach ($data as $row) {?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url()?>Tampilan_user/Tam_user/detail/<?= $row->id_anggota;?>" class="btn btn-info btn-xs">Detail</a>
                                <a href="<?= base_url()?>Tampilan_user/Tam_user/Cetak_kartu_ang/<?= $row->id_anggota;?>" class="btn btn-primary fa fa-print "> Cetak Kartu</a>
                            </td>
                        </tr>
                    <?php }
                ?>
